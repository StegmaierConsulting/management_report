...
const CourseOfActionForm: React.FC = () => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLTextAreaElement>, name: string) => {
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          ...
          <tr>
            <td colSpan={11} className="bg-[#00B0F0]">
              <div className="flex items-center w-full">
                ...
                <textarea className="ml-2 flex-1 border-none focus:outline-none bg-transparent resize-none" onChange={handleMainInputChange}  
                style={{
                  minHeight: '30px', 
                  width: '100%', 
                }}
          ...
          <tr>
            <td style={{ width: columnSizes[0], minWidth: columnSizes[0], maxWidth: columnSizes[0] }} className="border-none" colSpan={2}>
              <div className="flex items-center w-full">
                ...
                <textarea className="ml-2 flex-1 border-none focus:outline-none bg-transparent resize-none" onChange={handleDateChange} 
                style={{
                  minHeight: '30px', 
                  width: '100%', 
                }}
          ...
          <tr>
            ...
            <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300">
              <textarea value={inputValues['inicio1'] || ''} onChange={(e) => handleInputChange(e, 'inicio1')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300">
              <textarea value={inputValues['fin1'] || ''} onChange={(e) => handleInputChange(e, 'fin1')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
          ...
          <tr className="bg-[#D9E1F2]">
            ...
            <td style={{ width: columnSizes[1], minWidth: columnSizes[1], maxWidth: columnSizes[1] }} className="border border-gray-300 text-left align-middle">
              <textarea
                ...
                className="w-full border-none focus:outline-none text-center bg-transparent resize-none"
                style={{
                  minHeight: '30px', 
                  height: 'auto',
                }}
            ...
            <td style={{ width: columnSizes[2], minWidth: columnSizes[2], maxWidth: columnSizes[2] }} className="border border-gray-300 text-left align-middle">
              <textarea ref={setRef(0, 1)} value={inputValues['subtarea1'] || ''} onChange={(e) => handleInputChange(e, 'subtarea1')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300">
              <textarea value={inputValues['inicio2'] || ''} onChange={(e) => handleInputChange(e, 'inicio2')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300">
              <textarea value={inputValues['fin2'] || ''} onChange={(e) => handleInputChange(e, 'fin2')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[5], minWidth: columnSizes[5], maxWidth: columnSizes[5] }} className="border border-gray-300">
              <textarea ref={setRef(1, 0)} value={inputValues['responsable1'] || ''} onChange={(e) => handleInputChange(e, 'responsable1')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[6], minWidth: columnSizes[6], maxWidth: columnSizes[6] }} className="border border-gray-300">
              <textarea ref={setRef(2, 0)} value={inputValues['cliente1'] || ''} onChange={(e) => handleInputChange(e, 'cliente1')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[10], minWidth: columnSizes[10], maxWidth: columnSizes[10] }} className="border border-gray-300">
              <textarea value={inputValues['tipo1'] || ''} onChange={(e) => handleInputChange(e, 'tipo1')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
          ...
          {/* Nuevas filas */}
          {rows.map((row, index) => (
            <tr key={index} className={`bg-opacity-100 ${(index + 2) % 2 === 0 ? 'bg-white' : 'bg-[#D9E1F2]'}`}>
              ...
              <td style={{ width: columnSizes[1], minWidth: columnSizes[1], maxWidth: columnSizes[1] }} className="border border-gray-300 text-left align-middle">
                <textarea ref={setRef(index + 3, 0)} value={inputValues[`tarea${index + 2}`] || ''} onChange={(e) => handleInputChange(e, `tarea${index + 2}`)} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
                style={{
                  minHeight: '30px', 
                  height: 'auto',
                }}/>
              ...
              <td style={{ width: columnSizes[2], minWidth: columnSizes[2], maxWidth: columnSizes[2] }} className="border border-gray-300 text-left align-middle">
                <textarea ref={setRef(index + 3, 1)} value={inputValues[`subtarea${index + 2}`] || ''} onChange={(e) => handleInputChange(e, `subtarea${index + 2}`)} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
                style={{
                  minHeight: '30px', 
                  height: 'auto',
                }}/>
              ...
              <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300">
                <textarea value={inputValues[`inicio${index + 3}`] || date} onChange={(e) => handleInputChange(e, `inicio${index + 3}`)} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
                style={{
                  minHeight: '30px', 
                  height: 'auto',
                }}/>
              ...
              <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300">
                <textarea value={inputValues[`fin${index + 3}`] || inputValues.fin1} onChange={(e) => handleInputChange(e, `fin${index + 3}`)} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
                style={{
                  minHeight: '30px', 
                  height: 'auto',
                }}/>
              ...
              <td style={{ width: columnSizes[5], minWidth: columnSizes[5], maxWidth: columnSizes[5] }} className="border border-gray-300">
                <textarea ref={setRef(index + 3, 2)} value={inputValues[`responsable${index + 2}`] || ''} onChange={(e) => handleInputChange(e, `responsable${index + 2}`)} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
                style={{
                  minHeight: '30px', 
                  height: 'auto',
                }}/>
              ...
              <td style={{ width: columnSizes[6], minWidth: columnSizes[6], maxWidth: columnSizes[6] }} className="border border-gray-300">
                <textarea ref={setRef(index + 3, 3)} value={inputValues[`cliente${index + 2}`] || ''} onChange={(e) => handleInputChange(e, `cliente${index + 2}`)} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
                style={{
                  minHeight: '30px', 
                  height: 'auto',
                }}/>
              ...
              <td style={{ width: columnSizes[9], minWidth: columnSizes[9], maxWidth: columnSizes[9] }} className="border border-gray-300 text-center align-middle">INMEDIATO</td>
              <td style={{ width: columnSizes[10], minWidth: columnSizes[10], maxWidth: columnSizes[10] }} className="border border-gray-300">
                <textarea value={inputValues[`tipo${index + 2}`] || ''} onChange={(e) => handleInputChange(e, `tipo${index + 2}`)} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
                style={{
                  minHeight: '30px', 
                  height: 'auto',
                }}/>
          ...
          {/* Fila existente: Reportar Avances de Plan de Acción */}
          <tr className={(rows.length + 2) % 2 === 0 ? 'bg-white' : 'bg-[#D9E1F2]'}>
            ...
            <td style={{ width: columnSizes[2], minWidth: columnSizes[2], maxWidth: columnSizes[2] }} className="border border-gray-300">
              <textarea ref={setRef(rows.length + 3, 0)} value={inputValues['subtarea5'] || ''} onChange={(e) => handleInputChange(e, 'subtarea5')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300">
              <textarea value={inputValues['inicio6'] || date} onChange={(e) => handleInputChange(e, 'inicio6')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300">
              <textarea value={inputValues['fin6'] || inputValues.fin1} onChange={(e) => handleInputChange(e, 'fin6')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[5], minWidth: columnSizes[5], maxWidth: columnSizes[5] }} className="border border-gray-300">
              <textarea ref={setRef(rows.length + 3, 1)} value={inputValues['responsable5'] || ''} onChange={(e) => handleInputChange(e, 'responsable5')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[6], minWidth: columnSizes[6], maxWidth: columnSizes[6] }} className="border border-gray-300">
              <textarea ref={setRef(rows.length + 3, 2)} value={inputValues['cliente5'] || ''} onChange={(e) => handleInputChange(e, 'cliente5')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
            ...
            <td style={{ width: columnSizes[9], minWidth: columnSizes[9], maxWidth: columnSizes[9] }} className="border border-gray-300 text-center align-middle">INMEDIATO</td>
            <td style={{ width: columnSizes[10], minWidth: columnSizes[10], maxWidth: columnSizes[10] }} className="border border-gray-300">
              <textarea value={inputValues['tipo5'] || ''} onChange={(e) => handleInputChange(e, 'tipo5')} className="w-full border-none focus:outline-none text-center bg-transparent resize-none" 
              style={{
                minHeight: '30px', 
                height: 'auto',
              }}/>
