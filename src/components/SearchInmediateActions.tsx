...
import InmediateActionsEdit, { DatosExtraidos } from '@/components/inmediateActionsEdit';
...
const SearchForms: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    const collectionPath = `USERAUTH/${selectedEmpresa}/InmediateActions`;
