        ...
        <tbody className="bg-white divide-y divide-gray-200">
          ...
          <tr style={{ height: rowSizes[2] }}>
            ...
            <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300">
              <textarea
                ...
                value={inputValues['inicio1'] || autoDate}
            ...
            <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['fin1'] || autoDate}
                onChange={(e) => handleInputChange(e, 'fin1')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
          ...
          <tr style={{ height: rowSizes[5] }}>
            ...
            <td style={{ width: columnSizes[2], minWidth: columnSizes[2], maxWidth: columnSizes[2] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['inicio2'] || autoDate}
            ...
            <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['fin2'] || autoDate}
            ...
            <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['responsable1'] || ''}
          ...
          <tr style={{ height: rowSizes[6] }}>
            ...
            <td style={{ width: columnSizes[2], minWidth: columnSizes[2], maxWidth: columnSizes[2] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['inicio3'] || autoDate}
                onChange={(e) => handleInputChange(e, 'inicio3')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
            <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['fin3'] || autoDate}
                onChange={(e) => handleInputChange(e, 'fin3')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
            <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['responsable2'] || ''}
                onChange={(e) => handleInputChange(e, 'responsable2')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
            ...
            <td style={{ width: columnSizes[9], minWidth: columnSizes[9], maxWidth: columnSizes[9] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['tipo2'] || ''}
                onChange={(e) => handleInputChange(e, 'tipo2')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
          </tr>
          ...
          <tr style={{ height: rowSizes[7] }}>
            ...
            <td style={{ width: columnSizes[2], minWidth: columnSizes[2], maxWidth: columnSizes[2] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['inicio4'] || autoDate}
                onChange={(e) => handleInputChange(e, 'inicio4')}
                className="w-full h-full border-none focus:outline-none text-center bg-[#D9E1F2] bg-opacity-100"
              />
            </td>
            <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['fin4'] || autoDate}
                onChange={(e) => handleInputChange(e, 'fin4')}
                className="w-full h-full border-none focus:outline-none text-center bg-[#D9E1F2] bg-opacity-100"
              />
            </td>
            <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['responsable3'] || ''}
                onChange={(e) => handleInputChange(e, 'responsable3')}
                className="w-full h-full border-none focus:outline-none text-center bg-[#D9E1F2] bg-opacity-100"
              />
            </td>
            <td style={{ width: columnSizes[5], minWidth: columnSizes[5], maxWidth: columnSizes[5] }} className="border border-gray-300 bg-[#D9E1F2]">
            ...
            <td style={{ width: columnSizes[9], minWidth: columnSizes[9], maxWidth: columnSizes[9] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['tipo3'] || ''}
                onChange={(e) => handleInputChange(e, 'tipo3')}
                className="w-full h-full border-none focus:outline-none text-center bg-[#D9E1F2] bg-opacity-100"
              />
            </td>
          </tr>
          ...
          <tr style={{ height: rowSizes[8] }}>
            ...
            <td style={{ width: columnSizes[2], minWidth: columnSizes[2], maxWidth: columnSizes[2] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['inicio5'] || autoDate}
                onChange={(e) => handleInputChange(e, 'inicio5')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
            <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['fin5'] || autoDate}
                onChange={(e) => handleInputChange(e, 'fin5')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
            <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['responsable4'] || ''}
                onChange={(e) => handleInputChange(e, 'responsable4')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
            <td style={{ width: columnSizes[5], minWidth: columnSizes[5], maxWidth: columnSizes[5] }} className="border border-gray-300">
            ...
            <td style={{ width: columnSizes[9], minWidth: columnSizes[9], maxWidth: columnSizes[9] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['tipo4'] || ''}
                onChange={(e) => handleInputChange(e, 'tipo4')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
          </tr>
          ...
          <tr style={{ height: rowSizes[9] }}>
            ...
            <td style={{ width: columnSizes[2], minWidth: columnSizes[2], maxWidth: columnSizes[2] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['inicio6'] || autoDate}
                onChange={(e) => handleInputChange(e, 'inicio6')}
                className="w-full h-full border-none focus:outline-none text-center bg-[#D9E1F2] bg-opacity-100"
              />
            </td>
            <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['fin6'] || autoDate}
                onChange={(e) => handleInputChange(e, 'fin6')}
                className="w-full h-full border-none focus:outline-none text-center bg-[#D9E1F2] bg-opacity-100"
              />
            </td>
            <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['responsable5'] || ''}
                onChange={(e) => handleInputChange(e, 'responsable5')}
                className="w-full h-full border-none focus:outline-none text-center bg-[#D9E1F2] bg-opacity-100"
              />
            </td>
            <td style={{ width: columnSizes[5], minWidth: columnSizes[5], maxWidth: columnSizes[5] }} className="border border-gray-300 bg-[#D9E1F2]">
            ...
            <td style={{ width: columnSizes[9], minWidth: columnSizes[9], maxWidth: columnSizes[9] }} className="border border-gray-300 bg-[#D9E1F2]">
              <textarea
                ...
                onChange={(e) => handleInputChange(e, 'tipo5')}
                className="w-full h-full border-none focus:outline-none text-center bg-[#D9E1F2] bg-opacity-100"
              />
            </td>
          </tr>
          ...
          <tr style={{ height: rowSizes[10] }}>
            ...
            <td style={{ width: columnSizes[2], minWidth: columnSizes[2], maxWidth: columnSizes[2] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['inicio7'] || autoDate}
                onChange={(e) => handleInputChange(e, 'inicio7')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
            <td style={{ width: columnSizes[3], minWidth: columnSizes[3], maxWidth: columnSizes[3] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['fin7'] || autoDate}
                onChange={(e) => handleInputChange(e, 'fin7')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
            <td style={{ width: columnSizes[4], minWidth: columnSizes[4], maxWidth: columnSizes[4] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['responsable6'] || ''}
                onChange={(e) => handleInputChange(e, 'responsable6')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
            <td style={{ width: columnSizes[5], minWidth: columnSizes[5], maxWidth: columnSizes[5] }} className="border border-gray-300">
            ...
            <td style={{ width: columnSizes[9], minWidth: columnSizes[9], maxWidth: columnSizes[9] }} className="border border-gray-300">
              <textarea
                style={{ width: '100%', height: '100%', resize: 'none' }}
                value={inputValues['tipo6'] || ''}
                onChange={(e) => handleInputChange(e, 'tipo6')}
                className="w-full h-full border-none focus:outline-none text-center"
              />
            </td>
          </tr>
