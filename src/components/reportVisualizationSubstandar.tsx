...
import { DatosExtraidos } from './substandarCondition';
...
const VisualizacionReporte: React.FC<VisualizacionReporteProps> = ({ datos, imagenes }) => {
  ...
  const generateWord = async () => {
    const children = [
      new Paragraph({
        children: [
          new TextRun({
            text: "Reporte de Condición Subestándar",
            bold: true,
      ...
      new Paragraph({
        children: [
          ...
          new TextRun({
            text: correctedData.fotografias || '',
            color: "0070c0",
            size: 22, // Tamaño de letra 11pt
            font: "Calibri",
          }),
  ...
  return (
    <div>
      <div className="p-6 bg-white rounded-lg shadow-lg">
        <h1 className="text-2xl font-medium text-gray-800 mb-4">Reporte de Condición Subestándar</h1>
...
export default VisualizacionReporte;
