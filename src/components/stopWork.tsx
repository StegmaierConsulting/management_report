...
function StopWork({ datos, onDatosChange, onFileChange }: StopWorkProps) {
  ...
  return (
    <form className="max-w-md p-6 bg-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-medium text-gray-800 mb-4">Reporte de Condición Stop Work</h2>
