...
import AutomaticLanguageChecker from '../components/automaticLanguageCheckerSubStandar';
import SubstandardCondition, { DatosExtraidos } from '../components/substandarCondition';
import VisualizacionReporte from '@/components/reportVisualizationSubstandar';
import { Header } from '@/components/header';
import '@/app/globals.css';

export default function Tolerance0SubstandardCondition() {
  ...
  return (
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 gap-4 p-4 mt-24">
      ...
      <div>
        <VisualizacionReporte datos={datosExtraidos} imagenes={previas} />
      </div>
    </div>
    </>
  );
